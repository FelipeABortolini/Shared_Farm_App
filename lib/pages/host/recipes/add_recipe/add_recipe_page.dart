...
import '../../../../db/recipes/register_recipe_element.dart';
import '../../../../db/recipes/utils/get_recipe.dart';
...
class AddRecipePage extends HookConsumerWidget {
  ...
  RegisterRecipeElement registerRecipeElement = RegisterRecipeElement();
          ...
          if (!isLoading.isLoading) {
            ...
            try {
              if ((amountProducts.amount >= 1 && prod1.quantity.text.isEmpty) ||
                  ...
                  (prod1.category.text == "" && prod1.code.text == "") ||
                  (amountProducts.amount > 1 &&
                      (prod2.category.text == "" && prod2.code.text == "")) ||
                  (amountProducts.amount > 2 &&
                      (prod3.category.text == "" && prod3.code.text == "")) ||
                  (amountProducts.amount > 3 &&
                      (prod4.category.text == "" && prod4.code.text == "")) ||
                  (amountProducts.amount > 4 &&
                      (prod5.category.text == "" && prod5.code.text == "")) ||
                  (amountProducts.amount > 5 &&
                      (prod6.category.text == "" && prod6.code.text == "")) ||
                  (amountProducts.amount > 6 &&
                      (prod7.category.text == "" && prod7.code.text == "")) ||
                  (amountProducts.amount > 7 &&
                      (prod8.category.text == "" && prod8.code.text == "")) ||
                  (amountProducts.amount > 8 &&
                      (prod9.category.text == "" && prod9.code.text == "")) ||
                  (amountProducts.amount > 9 &&
                      (prod10.category.text == "" && prod10.code.text == ""))) {
                ...
                List<Map<String, dynamic>> l =
                    await getRecipe.get(cultureType.result, phaseOption.phase);

                if (l.isEmpty) {
                  await registerRecipeElement.register(
                  ...
                  // ignore: use_build_context_synchronously
                  await alert.alert(context, "Receita adicionada com sucesso.",
                  ...
                  await alert.alert(
                      context,
                      "Receita já cadastrada, para realizar alterações você pode editá-la.",
                      "ERRO!",
                      AlertType.error);
                }
              ...
              isLoading.resetIsLoading();
              // ignore: use_build_context_synchronously
              alert.alert(context, "Erro ao cadastrar nova receita.", "ERRO!",
                  AlertType.error);
            }
          }
        },
