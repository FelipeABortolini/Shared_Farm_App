...
class AddRecipeSelectPage extends HookConsumerWidget {
  AddRecipeSelectPage({super.key});
                        ...
                        ? Column(
                            children: [
                              ...
                              (phaseOption.phase == 'APLICAÇÃO V2-V3')
                                  ? Opacity(
                                      opacity: 1,
                                      child: PhaseOption(phase: 'APLICAÇÃO V2-V3'))
                                  : Opacity(
                                      opacity: 0.35,
                                      child: PhaseOption(phase: 'APLICAÇÃO V2-V3')),
                                ...
                                children: [
                                  ...
                                  (phaseOption.phase == 'EMBORRACHAMENTO')
                                      ...
                                      : Opacity(
                                          ...
                                          child: PhaseOption(
                                              phase: 'EMBORRACHAMENTO')),
                                  (phaseOption.phase == 'ESPIGAMENTO/FLORESCIMENTO')
                                      ? Opacity(
                                          opacity: 1,
                                          child: PhaseOption(
                                              phase: 'ESPIGAMENTO/FLORESCIMENTO'))
                                      : Opacity(
                                          opacity: 0.35,
                                          child: PhaseOption(
                                              phase: 'ESPIGAMENTO/FLORESCIMENTO')),
